  ...
  return (
    <div className="flex h-full w-full bg-background relative overflow-hidden">
      <div className="flex-1 flex flex-col h-full min-w-0 relative">
        ...
        <header className={`glass-navbar absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 sm:px-6 py-3.5 min-h-[73px] transition-transform duration-300 ease-in-out gap-2 ${showHeader ? 'translate-y-0' : '-translate-y-full'
          }`}>
                  ...
                  <div className="space-y-2 bg-white/5 border border-white/5 p-3 rounded-xl">
                    ...
                    <div className="space-y-1.5 pt-1">
                      <button
                        ...
                        className={`w-full px-3 py-2.5 rounded-xl border text-left transition-all text-xs cursor-pointer ${activeModel === 'gemini-1.5-pro'
                      ...
                      <button
                        ...
                        className={`w-full px-3 py-2.5 rounded-xl border text-left transition-all text-xs cursor-pointer ${activeModel === 'llama-3.3-70b-versatile'
                            ? 'bg-primary/15 border-primary/35 text-white shadow-md shadow-primary/5'
                            : 'bg-white/5 border-white/5 text-text-secondary hover:bg-white/10 hover:border-white/10'
                          }`}
                      >
